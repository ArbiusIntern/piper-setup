const defaults = {
  ...
  fastspeech2_apikey: process.env.NEXT_PUBLIC_FASTSPEECH2_APIKEY ??'',
  fastspeech2_url: process.env.NEXT_PUBLIC_FASTSPEECH2_URL ?? "https://api-inference.huggingface.co/models/facebook/fastspeech2-en-ljspeech",
